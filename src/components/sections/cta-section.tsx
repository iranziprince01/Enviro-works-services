...
export function CtaSection({
  ...
  description = "Book your free quote today. EnviroWorks Services Inc delivers reliable cleaning, maintenance, landscaping, and snow removal across Edmonton and Alberta, with clear pricing and service you can trust.",
